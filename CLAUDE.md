...
- **Prompts are markdown files** in `app/publishing/prompts/` loaded by name (e.g. `checker.md`). The repository is an `AbstractPromptRepository`; tests use `FakeFileSystem` (`tests/infra/prompts/fakes.py`) rather than touching disk.
