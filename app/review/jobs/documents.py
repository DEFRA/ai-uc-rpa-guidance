"""Document content port and adapter for the review jobs domain.

Review owns the DocumentContentSource Protocol (port). The wiring layer
provides GuidanceDocumentContentSource, which bridges the guidance sub-domain
without leaking its internals into review.
"""
...
class DocumentContentSource(Protocol):
    """Port: provides document content to the review jobs domain."""
