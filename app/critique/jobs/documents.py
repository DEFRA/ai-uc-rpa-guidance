"""Document content port and adapter for the content review jobs domain.

Critique owns the DocumentContentSource Protocol (port). The wiring layer
provides GuidanceDocumentContentSource, which bridges the guidance sub-domain
without leaking its internals into critique.
"""
...
class DocumentContent:
    """Content loaded for a guidance document prior to review."""
...
class DocumentContentSource(Protocol):
    """Port: provides document content to the content review jobs domain."""
