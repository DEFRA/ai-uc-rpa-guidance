"""FastAPI dependency injection for the content review jobs domain."""
...
from app.critique.jobs import documents, repository, service, submitter
...
def get_job_repository(
...
) -> repository.AbstractCritiqueJobRepository:
    """Provide a critique job repository.
    ...
    """
    return repository.MongoCritiqueJobRepository(db)
...
def get_critique_job_service(
    ...
    """Provide the critique job service.
    ...
    Returns:
        CritiqueJobService instance.
    """
    return service.CritiqueJobService(job_repo, content_source, job_submitter)
