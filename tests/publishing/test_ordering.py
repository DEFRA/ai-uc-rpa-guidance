"""Tests for presentation-stage ordering of analysis findings."""

from app.publishing import models, ordering
...
def _sections(findings: list[models.AnalysisFinding]) -> list[str]:
